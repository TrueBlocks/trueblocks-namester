...
func getTransfersFields() []types.FieldConfig {
	return []types.FieldConfig{
		...
		{Key: "logIndex", Label: "Log Index", ColumnLabel: "Log Index", DetailLabel: "Log Index", Section: "Transaction Info", Width: 80, Order: 3, DetailOrder: 20},
		{Key: "from", Label: "From", ColumnLabel: "From", DetailLabel: "From", Formatter: "address", Section: "Transfer Details", Width: 340, Order: 4, DetailOrder: 1},
		{Key: "to", Label: "To", ColumnLabel: "To", DetailLabel: "To", Formatter: "address", Section: "Transfer Details", Width: 340, Order: 5, DetailOrder: 2},
		{Key: "asset", Label: "Asset", ColumnLabel: "Asset", DetailLabel: "Asset", Formatter: "address", Section: "Transfer Details", Width: 340, Order: 6, DetailOrder: 4},
		{Key: "amount", Label: "Amount", ColumnLabel: "Amount", DetailLabel: "Amount", Formatter: "wei", Section: "Amount Breakdown", Width: 150, Order: 7, DetailOrder: 6},
		{Key: "actions", Label: "Actions", ColumnLabel: "Actions", DetailLabel: "Actions", Section: "", NoDetail: true, Width: 80, Order: 8},
		{Key: "sender", Label: "Sender", DetailLabel: "Sender", Formatter: "address", Section: "Transfer Details", NoTable: true, DetailOrder: 3},
		{Key: "recipient", Label: "Recipient", DetailLabel: "Recipient", Formatter: "address", Section: "Transfer Details", NoTable: true, DetailOrder: 4},
		{Key: "holder", Label: "Holder", DetailLabel: "Holder", Formatter: "address", Section: "Transfer Details", NoTable: true, DetailOrder: 3},
		{Key: "decimals", Label: "Decimals", DetailLabel: "Decimals", Section: "Transfer Details", NoTable: true, DetailOrder: 5},
		{Key: "amountIn", Label: "Amount In", DetailLabel: "Amount In", Formatter: "wei", Section: "Amount Breakdown", NoTable: true, DetailOrder: 7},
		{Key: "amountOut", Label: "Amount Out", DetailLabel: "Amount Out", Formatter: "wei", Section: "Amount Breakdown", NoTable: true, DetailOrder: 8},
		{Key: "internalIn", Label: "Internal In", DetailLabel: "Internal In", Formatter: "wei", Section: "Amount Breakdown", NoTable: true, DetailOrder: 8},
		{Key: "internalOut", Label: "Internal Out", DetailLabel: "Internal Out", Formatter: "wei", Section: "Amount Breakdown", NoTable: true, DetailOrder: 9},
		{Key: "gasOut", Label: "Gas Out", DetailLabel: "Gas Out", Formatter: "wei", Section: "Amount Breakdown", NoTable: true, DetailOrder: 10},
		{Key: "minerBaseRewardIn", Label: "Base Reward In", DetailLabel: "Base Reward In", Formatter: "wei", Section: "Mining Rewards", NoTable: true, DetailOrder: 11},
		{Key: "minerNephewRewardIn", Label: "Nephew Reward In", DetailLabel: "Nephew Reward In", Formatter: "wei", Section: "Mining Rewards", NoTable: true, DetailOrder: 12},
		{Key: "minerTxFeeIn", Label: "Tx Fee In", DetailLabel: "Tx Fee In", Formatter: "wei", Section: "Mining Rewards", NoTable: true, DetailOrder: 13},
		{Key: "minerUncleRewardIn", Label: "Uncle Reward In", DetailLabel: "Uncle Reward In", Formatter: "wei", Section: "Mining Rewards", NoTable: true, DetailOrder: 14},
		{Key: "selfDestructIn", Label: "Self Destruct In", DetailLabel: "Self Destruct In", Formatter: "wei", Section: "Special Transfers", NoTable: true, DetailOrder: 15},
		{Key: "selfDestructOut", Label: "Self Destruct Out", DetailLabel: "Self Destruct Out", Formatter: "wei", Section: "Special Transfers", NoTable: true, DetailOrder: 16},
