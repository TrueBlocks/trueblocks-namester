module github.com/TrueBlocks/trueblocks-namester

// GoLang version
go 1.23.8

require (
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20250704193713-7e36d71fd0b5
	github.com/TrueBlocks/trueblocks-dalle/v2 v2.0.0-20250504164335-8b49b03dddef
	github.com/TrueBlocks/trueblocks-sdk/v5 v5.3.1-0.20250704193614-2fb14285a56d
